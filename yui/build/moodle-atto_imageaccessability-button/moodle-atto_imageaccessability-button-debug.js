YUI.add('moodle-atto_imageaccessability-button', function (Y, NAME) {
 ...
 * @copyright  2017  <service@sysbind.co.il>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module moodle-atto_imageaccessability_alignment-button
 */

/**
 * Atto image selection tool.
 *
 * @namespace M.atto_imageaccessability
 * @class Button
...
var CSS = {
        ...
        INPUTALIGNMENT: 'atto_imageaccessability_alignment',
        INPUTALT: 'atto_imageaccessability_altentry',
        INPUTHEIGHT: 'atto_imageaccessability_heightentry',
        INPUTSUBMIT: 'atto_imageaccessability_urlentrysubmit',
        INPUTURL: 'atto_imageaccessability_urlentry',
        INPUTSIZE: 'atto_imageaccessability_size',
        INPUTWIDTH: 'atto_imageaccessability_widthentry',
        IMAGEALTWARNING: 'atto_imageaccessability_altwarning',
        IMAGEBROWSER: 'openimagebrowser',
        IMAGEPRESENTATION: 'atto_imageaccessability_presentation',
        INPUTCONSTRAIN: 'atto_imageaccessability_constrain',
        INPUTCUSTOMSTYLE: 'atto_imageaccessability_customstyle',
        IMAGEPREVIEW: 'atto_imageaccessability_preview',
        IMAGEPREVIEWBOX: 'atto_imageaccessability_preview_box',
        ALIGNSETTINGS: 'atto_imageaccessability_button'
    },
    SELECTORS = {
    ...
    COMPONENTNAME = 'atto_imageaccessability',
...
Y.namespace('M.atto_imageaccessability').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    /**
    ...
    /**
     * Upadte image alt after chese image if alt is empty
     * @param {string} imageurl url of the image file
     */
    _autoLabel: function(imageurl) {
        var input = this._form.one('.' + CSS.INPUTALT);
        var url = M.cfg.wwwroot + '/lib/editor/atto/plugins/imageaccessability/ajax.php';
        var params = {
        ...
        if (input.get('value') == '') {
            Y.io(url, {
                ...
                data: params,
                on: {
                    complete: function(id, preview) {
                        input.set('value', preview.responseText);
                    }
                }
            });
        }
    ...
    _getAlignmentPropeties: function(image, properties) {
        ...
        complete = ALIGNMENTS.some(function(alignment) {
            ...
            if (image.hasClass(classname)) {
                ...
                Y.log('Found alignment ' + alignment.value, 'debug', 'atto_imageaccessability-button');
    ...
    _removeLegacyAlignment: function(imageNode) {
        ...
        ALIGNMENTS.some(function(alignment) {
            ...
            Y.log('Legacy alignment found and removed.', 'info', 'atto_imageaccessability-button');
